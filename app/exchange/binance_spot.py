...
class BinanceSpotGateway:
    def __init__(self) -> None:
        self.client = SpotClient(key=settings.binance_api_key, secret=settings.binance_api_secret)
    ...
    def ticker(self, symbol: str) -> Dict[str, Any]:
        return guarded_call(self.client.ticker_price, symbol=symbol, limiter=self.limiter)
